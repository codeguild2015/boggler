...
def main():
    ...
    result = sorted(list(set(results)))

    #    Print each word and its score
	
    for words in result:
	    
        print('words: ', words, 'score:' , score(words))
	...
	for words in result:
	     total_score.append(score(words))
...
8+	    11
"""
	#DONE??? -FIXME  score the word correctly
